...
#include "BadLuck_TrapRelease_PowerUp.h"
...
void ABadLuck_TrapRelease_PowerUp::Expired()
{
	Super::Expired();
}

void ABadLuck_TrapRelease_PowerUp::Activated(AActor* OtherActor)
{
